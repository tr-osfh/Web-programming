...
var _ComboBoxItem = require('./ComboBoxItem');
...
function updatePseudoClassStyle(styleId, caretStyleId, properties) {
  ...
  var focusStyle = _extends({}, _styles2.default.focusStyle, properties.focusStyle);
  var disabledHoverStyle = _extends({}, _styles2.default.disabledHoverStyle, properties.disabledHoverStyle);
  var caretFocusStyle = _extends({}, _styles2.default.caretFocusStyle);
...
var ComboBox = function (_Component) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var inputStyle = _extends({}, _styles2.default.style, this.props.style);
      var hintStyle = _extends({}, _styles2.default.hintStyle, this.props.hintStyle);
      ...
      if (this.props.disabled) {
        inputStyle = _extends({}, inputStyle, _styles2.default.disabledStyle, this.props.disabledStyle);
      }
      ...
      if (this.props.displayCaret) {
        if (this.props.disabled) {
          caretStyle = _extends({}, _styles2.default.caretToOpenStyle, this.props.caretToOpenStyle, _styles2.default.disabledCaretToOpenStyle, this.props.disabledCaretToOpenStyle);
        } else if (this.state.isOpen) {
          caretStyle = _extends({}, _styles2.default.caretToCloseStyle, this.props.caretToCloseStyle);
        } else {
          caretStyle = _extends({}, _styles2.default.caretToOpenStyle, this.props.caretToOpenStyle);
        }
      }
