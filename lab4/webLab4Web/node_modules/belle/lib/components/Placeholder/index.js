...
var Placeholder = function (_Component) {
  ...
  _createClass(Placeholder, [{
    ...
    value: function render() {
      var computedStyle = _extends({}, _styles2.default.style, this.props.style);
      if (this.props._isDisabled) {
        computedStyle = _extends({}, computedStyle, _styles2.default.disabledStyle, this.props.disabledStyle);
      }
