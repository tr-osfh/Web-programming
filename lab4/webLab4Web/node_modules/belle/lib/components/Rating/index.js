...
function updatePseudoClassStyle(ratingWrapperStyleId, properties, preventFocusStyleForTouchAndClick) {
  ...
  if (preventFocusStyleForTouchAndClick) {
    ...
    ratingFocusStyle = _extends({}, _styles2.default.focusStyle, properties.focusStyle);
  }
...
var Rating = function (_Component) {
  ...
  _createClass(Rating, [{
    ...
    value: function render() {
      ...
      var characterStyle = _extends({}, _styles2.default.characterStyle, this.props.characterStyle);

      if (this.state.isActive) {
        characterStyle = _extends({}, characterStyle, _styles2.default.activeCharacterStyle, this.props.activeCharacterStyle);
      } else if (this.state.isHover) {
        characterStyle = _extends({}, characterStyle, _styles2.default.hoverCharacterStyle, this.props.hoverCharacterStyle);
      }
      ...
      if (this.props.disabled) {
        ...
        if (this.state.isHover) {
          wrapperStyle = _extends({}, wrapperStyle, _styles2.default.disabledHoverStyle, this.props.disabledHoverStyle);
        }
      } else {
        ...
        if (this.state.isHover) {
          wrapperStyle = _extends({}, wrapperStyle, _styles2.default.hoverStyle, this.props.hoverStyle);
        }
      }
